<?php
    ...
    class ForumApi4Gis extends Frontend
    {
        ...
        public function run()
        {
            ...
            \Contao\System::loadLanguageFile("tl_c4g_pn");
            ...
            try {// Maintenance mode
                ...
                if ($arrFragments[0] == "modal") {
                    if (!empty($arrFragments[1])) {
                        ...
                        $aReturn    = array();
                        $sClassName = "\\Con4Gis\\PN\\" . ucfirst($sType);
                    ...
                    if(empty($iRecipientId) && !empty($sRecipient)) {
                        $aRecipient = \Con4Gis\PN::getMemberByUsername($sRecipient);
                        if(empty($aRecipient)){
