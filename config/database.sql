...
CREATE TABLE `tl_module` (
  ...
  `c4g_forum_pagination_active` char(1) NOT NULL default '0',
  `c4g_forum_pagination_perpage` tinyint(3) NOT NULL default '10',
  `c4g_forum_pagination_format` varchar(255) NOT NULL default '[< ncn >]',
  ...
  `c4g_forum_bbcodes_editor_toolbaritems` varchar(600) NOT NULL default 'Cut,Copy,Paste,PasteText,PasteFromWord,-,Undo,Redo,TextColor,Bold,Italic,Underline,Strike,Subscript,Superscript,-,JustifyLeft,JustifyCenter,JustifyRight,JustifyBlock,-,RemoveFormat,NumberedList,BulletedList,Link,Unlink,Anchor,-,Image,Youtube,FileUpload,-,Smiley,-,Maximize,Source',
  `c4g_forum_bbcodes_smileys_url` char(128) NOT NULL default 'system/modules/con4gis_core/assets/vendor/wswgEditor/images/smilies',
  ...
  `c4g_forum_bbcodes_editor_imageHeight` varchar(10) NOT NULL default '600',
  `c4g_forum_ckeditor` char(1) NOT NULL default '0',
