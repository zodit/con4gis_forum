...
CREATE TABLE `tl_module` (
  ...
  `c4g_forum_bbcodes_editor_toolbaritems` varchar(600) NOT NULL default 'Cut,Copy,Paste,PasteText,PasteFromWord,-,Undo,Redo,TextColor,BGColor,Bold,Italic,Underline,Strike,Subscript,Superscript,Blockquote,-,JustifyLeft,JustifyCenter,JustifyRight,JustifyBlock,-,RemoveFormat,NumberedList,BulletedList,Link,Unlink,Anchor,Image,Youtube,FileUpload,Table,Smiley,Maximize',
