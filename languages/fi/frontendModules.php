 ...
 */
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['THREADDESC']              = 'Threadin kuvaus';
    $GLOBALS['TL_LANG']['C4G_FORUM']['EDIT_THREAD']             = 'Muokkaa threadia';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SAVE_THREAD_CHANGES']     = 'Tallenna muutokset threadiin';
    $GLOBALS['TL_LANG']['C4G_FORUM']['DEL_THREAD']              = 'Poista thread';
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['THREADS_LENGTHMENU'] = 'Näytä _MENU_ threadit';
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['ERROR_SAVE_POST']     = 'Virhe tallentaessa viestiä! Yritä uudelleen, tai ota yhteyttä foorumin ylläpitoon!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUCCESS_SAVE_POST']   = 'Uusi viesti tallennettiin onnistuneesti!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['ERROR_SAVE_THREAD']   = 'Virhe tallentaessa threadia! Yritä uudelleen, tai ota yhteyttä foorumin ylläpitoon!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUCCESS_SAVE_THREAD'] = 'Uusi thread tallennettiin onnistuneesti!';

    $GLOBALS['TL_LANG']['C4G_FORUM']['BOX_LAST_POST'] = 'Viimeisin post %s on %s threadissa %s';

    $GLOBALS['TL_LANG']['C4G_FORUM']['USER_NOT_LOGGED_IN'] = 'Jäsen ei ole kirjautunut sisään.';
    $GLOBALS['TL_LANG']['C4G_FORUM']['NO_PERMISSION']      = 'Pääsy evätty';

    $GLOBALS['TL_LANG']['C4G_FORUM']['PHP_ERROR'] = 'PHP Virhe! Yritä uudelleen, tai ota yhteyttä foorumin ylläpitoon!';
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_CANCEL']              = 'Peruuta tilaus';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_CANCEL_SUCCESS']        = 'Threadin tilaus peruutettu onnistuneesti.';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_CANCEL_SUCCESS']      = 'Foorumin tilaus peruutettu onnistuneesti.';

    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_ERROR']          = 'Virhe tilatessa threadia!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_SUCCESS']        = 'Thread tilattu onnistuneesti';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_ERROR']        = 'Virhe tilatessa foorumia!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_SUCCESS']      = 'Foorumi tilattu onnistuneesti';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_ONLY_THREADS'] = 'Ilmoita vain kun uusia threadeja on luotu';

    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_POSTS'] = 'viestit';
...
//        "\r\nTo cancel all subscriptions please use this link:\r\n%5\$s\r\n";
//
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_NEW']              = 'Uusi viesti';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_NEW_INTRO']        = "jäsen '%4\$s' lisäsi uuden viestin tilaamaasi threadiin '%3\$s' foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_EDIT']             = 'Viesti muokattu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_EDIT_INTRO']       = "jäsen '%4\$s' muokkasi viestiä tilaamassasi threadissa '%3\$s' foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_DELETE']           = 'Viesti poistettu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_DELETE_INTRO']     = "jäsen '%4\$s' poisti viestin tilaamassasi threadissa '%3\$s' foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_DELTHREAD']        = 'Thread poistettu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_DELTHREAD_INTRO']  = "Jäsen '%4\$s' poisti tilaamasi threadin '%3\$s' foorumissa '%2\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_MOVETHREAD']       = 'Thread siirretty';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_THREAD_MAIL_MOVETHREAD_INTRO'] = "jäsen '%4\$s' siirsi tilaamasi threadin '%3\$s' foorumilta '%6\$s' foorumiin '%2\$s'.\r\n";
//
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_NEW']              = 'Uusi viesti';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_NEW_INTRO']        = "jäsen '%4\$s' lisäsi uuden viestin threadiin '%3\$s' tilaamassasi foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_EDIT']             = 'Viesti muokattu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_EDIT_INTRO']       = "jäsen '%4\$s' muokkasi viestiä threadissa '%3\$s' tilaamassasi foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_DELETE']           = 'Viesti poistettu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_DELETE_INTRO']     = "jäsen '%4\$s' poisti viestin threadissa '%3\$s' tilaamassasi foorumissa '%2\$s' aiheena '%5\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_DELTHREAD']        = 'Thread poistettu';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_DELTHREAD_INTRO']  = "jäsen '%4\$s' poisti threadin '%3\$s' tilaamassasi foorumissa '%2\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_MOVETHREAD']       = 'Thread siirretty';
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_MOVETHREAD_INTRO'] = "jäsen '%4\$s' siirti threadin '%3\$s' foorumilta '%6\$s' foorumiin '%2\$s'.\r\n";
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_SUBFORUM_MAIL_NEWTHREAD_INTRO']  = "jäsen '%4\$s' lisäsi uuden threadin '%3\$s' tilaamassasi foorumissa '%2\$s'.\r\n";
//
//    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_LINK'] = "Linkki: '%s' (%s)\r\n";
//
...
//        "------------------------------------------------------------------------------------------\r\n";
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_NEW_POST']  = "viesti luotu";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_EDIT_POST'] = "viestiä muokattu";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_DEL_POST']  = "viesti poistettu";

    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_NEW_POST_WITH_SUBJECT']  = "viesti luotu aiheena '%s'";
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_DEL_THREAD']               = "thread poistettu";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_MOVE_THREAD']              = "thread siirretty";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_NEW_THREAD_WITH_SUBJECT']  = "thread luotu aiheena '%s'";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SUBSCRIPTION_MAIL_ACTION_EDIT_THREAD_WITH_SUBJECT'] = "threadia muokattu aiheena '%s'";
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['UNSUBSCRIBE_SUBFORUM_LINK_SUCCESS'] = 'Tilaus foorumista "%s" oli peruuttanut jäsen "%s"';
    $GLOBALS['TL_LANG']['C4G_FORUM']['UNSUBSCRIBE_SUBFORUM_LINK_FAILED']  = 'Virhe peruuttaessa tilausta foorumista!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['UNSUBSCRIBE_ALL_LINK_SUCCESS']      = 'Kaikki tilaukset jäseneltä "%s" on peruutettu!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['UNSUBSCRIBE_ALL_LINK_FAILED']       = 'Virhe yrittäessä peruuttaa kaikkia tilauksia!';


    $GLOBALS['TL_LANG']['C4G_FORUM']['MOVE_THREAD_TEXT']      = 'Siirrä thread <b>%s</b> foorumista <b>%s</b> seuraavaan foorumiin:';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MOVE_THREAD_ERROR']     = 'Virhe siirtäessä threadia!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MOVE_THREAD_SUCCESS']   = 'Thread siirretty onnistuneesti.';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MOVE_THREAD_NO_FORUMS'] = 'Foorumia ei löydetty jossa sinulla olisi oikeuksia siirtää valittua threadia.';

    $GLOBALS['TL_LANG']['C4G_FORUM']['EDIT_THREAD_ERROR']   = 'Virhe tallentaessa muutettua threadia!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['EDIT_THREAD_SUCCESS'] = 'Thread vaihdettu onnistuneesti.';

    $GLOBALS['TL_LANG']['C4G_FORUM']['DEL_POST_WARNING'] = 'Haluatko todella poistaa tämän viestin?<br/>' .
                                                           'Foorumi: <b>%s</b><br/>' .
                                                           'Thread: <b>%s</b><br/>' .
                                                           ' <b>%s</b><br/>' .
                                                           'Aihe: <b>%s</b><br/>';
    $GLOBALS['TL_LANG']['C4G_FORUM']['DEL_POST_ERROR']   = 'Virhe poistaessa viestiä!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['DEL_POST_SUCCESS'] = 'Viesti poistettu onnistuneesti.';
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['DELETE_LINK']    = 'Poista';

    $GLOBALS['TL_LANG']['C4G_FORUM']['THREADSORT'] = 'Järjestele';

    $GLOBALS['TL_LANG']['C4G_FORUM']['ADD_MEMBER']           = 'Lisää jäsen foorumiin';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MEMBER_GROUP']         = 'Jäsen ryhmä';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MEMBER']               = 'Jäsen';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MEMBER_GROUP_MISSING'] = 'Jäsen ryhmä puuttuu';
    $GLOBALS['TL_LANG']['C4G_FORUM']['MEMBER_MISSING']       = 'Jäsen puuttuu';
    $GLOBALS['TL_LANG']['C4G_FORUM']['ADD_MEMBER_ERROR']     = 'Virhe lisätessä jäsentä!';
    $GLOBALS['TL_LANG']['C4G_FORUM']['ADD_MEMBER_SUCCESS']   = 'Jäsen lisätty onnistuneesti foorumiin.';
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['DELETE_MAP_LOCATION']  = 'Poista %s';
    $GLOBALS['TL_LANG']['C4G_FORUM']['OSM_ID']               = 'OSM-ID: ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['GEO_COORDS']           = 'Geo koordinaatit (Lon,Lat): ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['LOCATION_STYLE']       = 'Tyyli: ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['LOCATION_LABEL']       = 'Merkitse: ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['LOCATION_TOOLTIP']     = 'Työkalutippi: ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['VIEW_MAP_FOR_POST']    = 'Katso karttaa';
    $GLOBALS['TL_LANG']['C4G_FORUM']['VIEW_MAP_FOR_FORUM']   = 'Katso karttaa';
    $GLOBALS['TL_LANG']['C4G_FORUM']['ERROR_MAP_NOT_ACTIVE'] = 'Kartan toiminnallisuus ei ole aktiivinen';

//search Dialog
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_HEADLINE']       = 'Etsi threadeja';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_LBL_SEARCH_FOR'] = 'Etsi';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_CB_ONLYTHREADS'] = "Etsi vain threadeja (jätä huomioimatta postit)";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_CB_WHOLEWORDS']  = "koko sanoja";

    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_LBL_SEARCH_ALL_THEMES'] = 'Etsi kaikista threadeista alkaen';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_STARTFORUM']        = 'Aloitaforum';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_LBL_DISPLAY_ONLY']      = 'Näytä vain threadit joissa on posteja käyttäjiltä:';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_LBL_AND_WHICH']         = 'ja mikä';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_CREATIONDATE']      = 'Luomis päivämäärä';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_LASTPOST']          = 'viimeisin post';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_PRIOR']             = 'ennestään';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_NOTPRIOR']          = 'eivät ennestään';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_LBL_IS_THAN']           = 'kuin';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_HOUR']              = 'tuntia';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_DAY']               = 'päivää';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHDIALOG_DDL_WEEK']              = 'viikkoa';
...
//search Resultpage
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_SEARCHTAGERROR']     = "[System]: 'Hakusi muodostuu vain pätemättömistä merkeistä!'";
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_SEARCHNOSUCHAUTHOR'] = "[System]: 'Ei ole sellaista tekijää.'";

    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_HEADLINE']                = 'Hakutulokset:';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_DATATABLE_AREA']          = 'Alue';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_DATATABLE_HITS']          = 'Osuu';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCHRESULTPAGE_BUTTON_START_NEW_SEARCH'] = 'Aloita uusi haku';

//search Helptexts
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCH_HELPTEXT_SEARCHFIELD'] = 'Hakutermit jotka pitäisi hakea.';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCH_HELPTEXT_AREA']        = 'Määrittelee hakualueen. ';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCH_HELPTEXT_AUTHOR']      = 'Jos käyttäjänimi on laitettu tänne, ' .
                                                                      'Vain threadit näytetään jotka hän on tehnyt.';
    $GLOBALS['TL_LANG']['C4G_FORUM']['SEARCH_HELPTEXT_TIMEPERIOD']  = 'Tämä valitsee threadin todellisuuden. ' .
                                                                      'Tämä voi viitata syntymäaikaan tai viimeisimpään viestiin. Jos laskuri on asetettu "0", ' .
    ...
    $GLOBALS['TL_LANG']['C4G_FORUM']['RATING']       = 'Arvostelut';
    $GLOBALS['TL_LANG']['C4G_FORUM']['STAR']         = "Tähti";
    $GLOBALS['TL_LANG']['C4G_FORUM']['STARS']        = "Tähteä";

    $GLOBALS['TL_LANG']['C4G_FORUM']['RESET_RATING']     = "Nollaa arvostelut";
    $GLOBALS['TL_LANG']['C4G_FORUM']['RATINGS_MULTIPLE'] = "Arvostelut";
    $GLOBALS['TL_LANG']['C4G_FORUM']['RATINGS_SINGLE']   = "Arvostelu";
?>