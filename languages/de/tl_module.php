...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_show_realname'] 	= array('Verwende richtige Namen anstelle des Benutzernamens',
																		'Wählen Sie ob und wie Sie die richtigen Namen der Benutzer anzeigen lassen wollen, anstelle ihrer Benutzernamen.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_postsort'] 			= array('Sortierung der Beiträge in der Beitragsliste',
																		'Wählen Sie, in welcher Reihenfolge die Beiträge in der Beitragsliste eines Themas angezeigt werden sollen.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_collapsible_posts'] = array('Beiträge klappbar machen',
																		'Wählen Sie ob und wie Sie die Beiträge des Forums klappbar machen möchten.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_breadcrumb'] 		= array('Navigationspfad anzeigen',
																		'Wählen Sie, ob der Navigationspfad generiert werden soll oder nicht.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_hide_intropages'] 	= array('Einstiegsseiten verstecken',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jumpTo'] 			= array('Weiterleitungsseite bei fehlender Berechtigung',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_bbcodes_autourl'] 	= array('Automatische URL-Erkennung verwenden',
																		'Deaktivieren Sie diese Checkbox, wenn Sie nicht wollen, dass URLs automatisch erkannt und in einen Link umgewandelt werden.');

$GLOBALS['TL_LANG']['tl_module']['c4g_forum_boxes_text'] 		= array('Navigationskacheln: Forenbereichsname anzeigen ',
																		'Wählen Sie, ob auf den Navigationskacheln der Forenbereichsname angezeigt werden soll oder nicht.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_boxes_subtext'] 	= array('Navigationskacheln: Detailinformationen anzeigen ',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_boxes_lastpost'] 	= array('Navigationskacheln: Informationen zum letzten Beitrag anzeigen ',
																		'Wählen Sie, ob auf den Navigationskacheln Informationen zum letzten Beitrag im Forum angezeigt werden sollen oder nicht.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_boxes_center'] 		= array('Navigationskacheln zentrieren ',
																		'Wählen Sie diese Option, wenn die Navigationskacheln zentriert angezeigt werden sollen.');

$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jqui'] 				= array('jQuery UI verwenden',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jqui_lib'] 			= array('jQuery UI Bibliothek laden',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_breadcrumb_jqui_layout'] 	= array('Navigationspfad im jQuery UI Layout',
																				'Wählen Sie, ob der Navigationspfad aus jQuery-UI Buttons bestehen sollen, oder ob sie normale Links bleiben sollen.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_table_jqui_layout'] = array('Themenliste im jQuery UI Layout',
																		'Wählen Sie, ob die Themenliste das jQuery UI Layout bekommen soll oder nicht.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_dialogs_embedded'] 	= array('Dialoge einbetten',
																		'Setzen Sie dieses Häkchen, damit Dialoge als eingebettete Elemente angezeigt werden.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_embdialogs_jqui'] 	= array('Eingebettete Dialoge im jQuery UI Layout',
																		'Deaktivieren Sie dieses Häkchen, damit eingebettete Dialoge nicht im jQuery UI Layout angezeigt werden.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_posts_jqui'] 		= array('Beitragsliste und Beiträge im jQuery UI Layout',
																		'Deaktivieren Sie dieses Häkchen, damit die Beiträge nicht im jQuery UI Layout angezeigt werden.');
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_boxes_jqui_layout'] = array('Navigationskacheln im jQuery UI Layout',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jquery_lib'] 		= array('jQuery Bibliothek laden',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jqtable_lib'] 		= array('jQuery DataTables Bibliothek laden',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jqhistory_lib'] 	= array('jQuery History Bibliothek laden',
...
$GLOBALS['TL_LANG']['tl_module']['c4g_forum_jqtooltip_lib'] 	= array('jQuery Tooltip Bibliothek laden',
